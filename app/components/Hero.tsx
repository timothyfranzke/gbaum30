...
const HeroSection = () => {
    return (
      <section 
        className="min-h-screen flex items-center relative pt-20 bg-cover bg-center bg-fixed"
        style={{
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div className="text-white">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Link
                  href="/train"
                  className="bg-orange-500 text-white px-8 py-4 rounded-full font-bold hover:bg-orange-600 transition text-center"
                >
                  Join Now
                </Link>
                <Link
                  href="/about#contact"
                  className="border-2 border-white text-white px-8 py-4 rounded-full font-bold hover:bg-white hover:text-gray-900 transition text-center"
                >
                  Request Info
                </Link>
              </div>
